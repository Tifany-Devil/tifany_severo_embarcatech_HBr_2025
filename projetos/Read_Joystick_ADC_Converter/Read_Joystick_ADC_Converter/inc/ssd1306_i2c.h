...
// Declarações de funções existentes (adicionadas para consistência)
...
// Adições para suportar a fonte maior
extern uint8_t font[]; // Declara o array font como externo
int ssd1306_get_font(uint8_t character); // Declara a função para mapear caracteres
